...
//					});
//					bb.setOnAction(e1 -> {
//						if (name.getText() == "" || date.getText() == "" || age.getText() == "" || loca.getText() == ""
//								|| Dist.getText() == "" || gender.getText() == "") {
//							displyLabel.setText("please enter valid value");
//							return;
//
//						}
//						String h;
//						h = name.getText().translateEscapes() + "," + date.getText().trim() + "," + age.getText().trim()
//								+ "," + loca.getText().trim() + "," + Dist.getText().trim() + ","
//								+ gender.getText().trim();
